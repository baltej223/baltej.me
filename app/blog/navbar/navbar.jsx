...
export default function Navbar({ title = "baltej.me" }) {
  ...
  return (
    <>
      <header
        className="z-[100] pt-10 pb-10 flex flex-row items-center sticky top-0 left-0 justify-center md:justify-between /*After this goes classes for glassmorphism*/ light:bg-[rgba(255, 255, 255, 0.6)]"
        style={{ backdropFilter: "blur( 10.5px )", opacity: "" }}
      >
        {" "}
        {/* dark:bg-[rgba(0,0,0,0.35)] */}
        <div
          className="pl-0  md:pl-20 text-3xl /*md:w-1/2*/ block font-bold"
  ...
  return (
    <>
      <div
        ...
        className="text-xl pl-0 flex flex-row gap-x-15 items-center hidden md:block md:flex lg:block lg:flex /*md:w-1/2*/ md:pr-20"
      >
        <div>
          <a href="/">Home</a>
        </div>
        ...
        <div>
          <a href="https://github.com/baltej223#connect-with-me">Contact Me</a>
        </div>
        <div>
      ...
      >
        <div className="p-4 h-full flex flex-col">
          ...
          <div className="mt-auto mb-7 p-4 flex flex-row">
            <p className="text-sm light:text-white dark:text-gray-500 w-[95%]">
              © {new Date().getFullYear()} Baltej.me
            </p>
            <ThemeToggle />
          </div>
        </div>
