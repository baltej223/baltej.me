...
export default function Home() {
  return (
    ...
    <Content className="gap-x-20 gap-y-20">
      ...
      <BlogCard src="https://avatars.githubusercontent.com/u/7552965?s=200&v=4" alt='some' href="./blog/connecting-to-mongo-using-mongoose-nextjs">
          <BlogCardTitle minsread="5-mins">
            Using Mongoose with NextJS serverless
          </BlogCardTitle>
          <BlogCardDesc>
          How is it diffrent from express
          </BlogCardDesc>
          <BlogAuthor>
            Baltej
          </BlogAuthor>
